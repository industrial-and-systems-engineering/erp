...
const Tcompleted = () => {
  ...
  // Add a key state to force re-render of CTcard
  ...
  const toggleEquipmentDetails = (product, form) => {
    if (selectedEquipment && selectedEquipment._id === product._id) {
      ...
      // This will force the CTcard component to re-render
    ...
    <div>
      {completedForms.length > 0 ? (
            ...
            {selectedEquipment && selectedForm ? (
              ...
              <div className='flex flex-col items-center justify-center h-full p-10 text-center'>
                ...
                <p className='text-gray-500'>
                  Select calibrated equipment from the list to view details
                </p>
              </div>
            )}
          </div>
        ...
        <div className='bg-white rounded-lg shadow-md p-10 text-center'>
          ...
          <h3 className='text-xl font-medium text-gray-600 mb-2'>No Calibrated Equipment</h3>
          <p className='text-gray-500'>
            There are currently no calibrated equipment items to display.
          </p>
        </div>
      )}
    </div>
