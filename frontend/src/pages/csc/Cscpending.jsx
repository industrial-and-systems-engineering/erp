                                                    ...
                                                    <div className="space-y-2">
                                                        <div className="flex items-center">
                                                            <input
                                                                ...
                                                                className="mr-2"
                                                                checked={
                                                                    formChanges.decisionRules?.noDecision ||
                                                                    false
                                                                }
                                                                onChange={(e) =>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            <p>
                                                                ...
                                                                {selectedForm
                                                                    .calibrationPeriodicity || "N/A"}
                                                            </p>
                                                            <p>
                                                                <span className="font-medium">
                                                                    Review Request:
                                                                </span>{" "}
                                                                {selectedForm.reviewRequest ||
                                                                    "None"}
                                                            </p>
                                                            <p>
                                                                <span className="font-medium">
                                                                ...
                                                                {selectedForm
                                                                    .calibrationFacilityAvailable || "N/A"}
                                                            </p>
                                                            <p>
                                                                <span className="font-medium">
                                                                    External Calibration:
