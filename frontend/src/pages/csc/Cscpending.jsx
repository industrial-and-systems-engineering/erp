      ...
      {pendingForms.length > 0 ? (
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
          ...
          <div className='bg-gray-50 rounded-lg shadow-md p-4 col-span-1 overflow-y-auto h-[87vh]'>
            <h2 className='font-semibold text-lg mb-4 text-gray-700 border-b pb-2'>SRF Forms</h2>
            <div className='space-y-3'>
              {pendingForms
                ...
                .map((form) => (
                  <div
                    key={form._id}
                    className={`bg-white p-4 rounded-lg shadow-sm border-l-4 transition-all duration-200 hover:shadow-md ${
                ...
                <div className='border-b pb-4 mb-4'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-4'>
                    <div>
                      ...
                      <p>
                        <span className='font-medium'>Email:</span> {selectedForm.emailId || "N/A"}
                      </p>
                    </div>
                    <div>
                      <h3 className='text-lg font-medium mb-2'>Form Details</h3>
                      <p>
                        <span className='font-medium'>SRF ID:</span> {selectedForm.srfNo || "N/A"}
                      </p>
                      <p>
                  ...
                  {isEditing ? (
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
                        <div className='space-y-3'>
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                handleInputChange("conditionOfProduct", e.target.value)
                              }
                            >
                        ...
                        <div className='space-y-3'>
                          ...
                          <div>
                            ...
                            <select
                              className='w-full border-gray-300 rounded-md shadow-sm p-2'
                              value={formChanges.calibrationPeriodicity || "None"}
                              onChange={(e) =>
                                handleInputChange("calibrationPeriodicity", e.target.value)
                              }
                            >
                              <option value=''>Select periodicity</option>
                              <option value='half-yearly'>Half-Yearly</option>
                              <option value='yearly'>Yearly</option>
                              <option value='none'>No Periodicity Required</option>
                            </select>
                          </div>
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                handleInputChange("calibrationFacilityAvailable", e.target.value)
                              }
                            >
                      ...
                      <div className='space-y-3'>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handleInputChange("calibrationMethodUsed", e.target.value)
                            }
                          />
                        </div>
                          ...
                          <div className='space-y-2'>
                            ...
                            <div className='flex items-center'>
                              <input
                                ...
                                onChange={(e) =>
                                  handleCheckboxChange("noDecision", e.target.checked)
                                }
                              />
                            ...
                            <div className='flex items-center'>
                              <input
                                ...
                                onChange={(e) =>
                                  handleCheckboxChange("simpleConformative", e.target.checked)
                                }
                              />
                            ...
                            <div className='flex items-center'>
                              <input
                                ...
                                className='mr-2'
                                checked={
                                  formChanges.decisionRules?.conditionalConformative || false
                                }
                                onChange={(e) =>
                                  handleCheckboxChange("conditionalConformative", e.target.checked)
                                }
                              />
                            ...
                            <div className='flex items-center'>
                              <input
                                ...
                                className='mr-2'
                                checked={
                                  formChanges.decisionRules?.customerDrivenConformative || false
                                }
                                onChange={(e) =>
                    ...
                    <div>
                      <div className='space-y-4'>
                        ...
                        <div className='border rounded-lg p-4 bg-gray-50'>
                          <h4 className='font-medium text-lg border-b pb-2 mb-3'>Form Details</h4>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            <div>
                              ...
                              <p>
                                <span className='font-medium'>Items Enclosed:</span>{" "}
                              ...
                              {selectedForm.decisionRules && (
                                <div className='mt-2'>
                                  ...
                                  <ul className='list-disc pl-5 mt-1 text-sm'>
                                    {selectedForm.decisionRules.noDecision && <li>No Decision</li>}
                            ...
                            <div>
                              <p>
                                <span className='font-medium'>Calibration Periodicity:</span>{" "}
                              ...
                              <p>
                                <span className='font-medium'>Calibration Facility:</span>{" "}
                                {selectedForm.calibrationFacilityAvailable || "N/A"}
                              </p>
                              <p>
                                <span className='font-medium'>External Calibration:</span>{" "}
                                {selectedForm.calibrationServiceDoneByExternalAgency}
                              </p>
                              <p>
                                <span className='font-medium'>Calibration Method:</span>{" "}
        ...
        <div className='bg-white rounded-lg shadow-md p-10 text-center'>
          ...
          <p className='text-gray-500'>There are currently no pending SRF forms to display.</p>
        </div>
      )}
    </div>
  );
